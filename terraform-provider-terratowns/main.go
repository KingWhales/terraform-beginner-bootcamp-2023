...
// func main(): Defines the main function, the entry point point of the application.
...
// in golang, a titlecase will get exported
func Provider() *schema.Provider{
	...
	p = &schema.Provider{
		...
		Schema: map[string]*schema.Resource{
			...
			"token": {
				Type: schema.TypeString,
				Sensitive: true, // It will mark the token as sensitive to hide the logs
				Required: true,
